...
export default function MenuPanel({ isOpen, onClose, onHelp, onLogout }) {
  return (
    <div className={`menu-slide-panel ${isOpen ? "open" : "closed"}`}>
      <div className="menu-content">
        ...
        <div className="menu-options">
          ...
          <div className="menu-option" onClick={onHelp}>
          ...
          <div className="menu-option" onClick={onLogout}>
